...
class YOLOV4Loss(nn.Module):
    def __init__(self, cfg_data, cfg_train):
        ...
        self.box_ratio = 0.05
        self.obj_ratio = 5 * (cfg_train.input_shape[0] * cfg_train.input_shape[1]) / (416 ** 2)
        self.cls_ratio = 1 * (self.num_classes / 80)

        self.focal_loss = cfg_train.focal_loss
        self.focal_loss_ratio = 10
        self.alpha = cfg_train.focal_alpha
        self.gamma = cfg_train.focal_gamma

        self.ignore_threshold = 0.5
        self.cuda = cfg_train.cuda
