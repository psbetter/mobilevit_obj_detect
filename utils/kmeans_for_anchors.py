...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', default="E:/PyCharmWorkSpace/datasets/mask/train", type=str, help='dataset root path')
    ...
    plt.savefig(args.save_path + "/kmeans_for_anchors.jpg")
    plt.show()
    ...
    f = open(args.save_path + "/anchors.txt", 'w')
